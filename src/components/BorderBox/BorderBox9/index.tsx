...
export interface BorderBox9Props extends BorderBoxCommonProps {}

export const BorderBox9 = forwardRef<AutoResizeActions, BorderBox9Props>(
  ({ children, className, style, color, backgroundColor = "transparent" }, ref) => {
    ...
    const classNames = useMemo(() => `dv-border-box-9${className ? ` ${className}` : ""}`, [className]);
