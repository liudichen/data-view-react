...
export interface BorderBox11Props extends BorderBoxCommonProps {
  title?: string;
  /**
   * @default 250
   */
...
export const BorderBox11 = forwardRef<AutoResizeActions, BorderBox11Props>(
  ({ children, className, style, color, backgroundColor = "transparent", title = "", titleWidth = 250 }, ref) => {
    ...
    const classNames = useMemo(() => `dv-border-box-11${className ? ` ${className}` : ""}`, [className]);
