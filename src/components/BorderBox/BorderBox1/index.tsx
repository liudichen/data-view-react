...
export interface BorderBox1Props extends BorderBoxCommonProps {}

export const BorderBox1 = forwardRef<AutoResizeActions, BorderBox1Props>(
  ({ children, className, style, color, backgroundColor = "transparent" }, ref) => {
    ...
    const classNames = useMemo(() => `dv-border-box-1${className ? ` ${className}` : ""}`, [className]);
